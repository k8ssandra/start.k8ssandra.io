...
export default {
  ...
  computed: {
    region: {
      get() {
        return this.$store.state.settings.k8_config.medusa.provider_s3.config.region;
      },
      set(value) {
    ...
    name: {
      get() {
        return this.$store.state.settings.k8_config.medusa.provider_s3.config.bucket_name;
      },
      set(value) {
    ...
    storage_secret: {
      get() {
        return this.$store.state.settings.k8_config.medusa.provider_s3.config.secret;
      },
      set(value) {
